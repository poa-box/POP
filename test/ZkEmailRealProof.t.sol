...
contract ZkEmailRealProofTest is Test {
    ...
    bytes32 constant D_PUBKEY = 0x1944995c806a6161432f4dacee6ba0be994d2633879d5bacc9e77a244e419aed;
    bytes32 constant D_NULLIFIER = 0x2bd088fb097b4d7583ba8586984d9146b94d599726e8a7362820af91cbbe89cc;
    // ── specific-address (v2) proof public signals ──
    bytes32 constant E_PUBKEY = 0x1944995c806a6161432f4dacee6ba0be994d2633879d5bacc9e77a244e419aed;
    bytes32 constant E_NULLIFIER = 0x2bd088fb097b4d7583ba8586984d9146b94d599726e8a7362820af91cbbe89cc;
    ...
    function _domainProof() internal pure returns (ZkEmailProof memory p) {
        p.pA = [
            uint256(0x2b5f3e390614c09e251616cf53ae15e32b8fd04a3a65a340906c808fd4879b27),
            0x12e13e4e7365b46a8ef4bf0b975a5e1d58145842b98f9ce02453c9a9ea4a9ffe
        ];
        p.pB = [
            [
                uint256(0x1f8906380b7db46079c823dd6a91537630386dfcb2d8f2e73bf016e6f866902a),
                0x22f09e5d2d40c6d30dd05ca5ef1f43216a869e937934fc9c33399f8cd856d774
            ],
            [
                uint256(0x1e7261a9cfeaaf473b41b68235a7dcf8a32913d3daaf524a334f8664645b6a35),
                0x0e246bebe91a27826b6cb60c70a11a58a2e21e2cbf32544ce589e9bcac531322
            ]
        ];
        p.pC = [
            uint256(0x2e1b7e47caa50c99b267a2352f15e86fbac64ef5197bd24a9dae5e50eb61e668),
            0x145e2585b0bf260304089ba963f5656cc1a4688f9c0bf28263a6aad46e7e8900
        ];
    ...
    function _emailProof() internal pure returns (ZkEmailProofV2 memory p) {
        p.pA = [
            uint256(0x0b70cd4fbf0986c631dd37332a0fd0682180505462ca78c9c8daa830333cb626),
            0x09113723b04b935c4d1e538f648ab85ef8ea4c9d794cdf1e9ac931e085399285
        ];
        p.pB = [
            [
                uint256(0x2b28d6fe330c4cd60d3171232758df6383ecb400e0d365ad51f14d6f29c2d6f5),
                0x18ffda432f648cf33fba1b08534bdcc293262394635a2f7f3b81b504fab03c97
            ],
            [
                uint256(0x118f3695fddae1e7267c2111d9fae9703a03ec28b026e2ac1f549e89f0e2bce1),
                0x1b6aa421d4cd970273f9b4a6092c07b0377542fb9f57b162ee01d8f4d8cdff5b
            ]
        ];
        p.pC = [
            uint256(0x17035f87540cd6c071e7615c2ff4d01971e610ef025b7d8d3ed2d99e0d122ae9),
            0x17e2318cfcc69a9e13cab47dd6236359da4ce2f5b9ef770556ac5531c3ba3cde
        ];
